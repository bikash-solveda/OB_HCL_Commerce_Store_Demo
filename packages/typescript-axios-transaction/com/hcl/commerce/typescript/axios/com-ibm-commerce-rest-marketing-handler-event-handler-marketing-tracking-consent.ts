 ...
 * @export
 * @interface ComIbmCommerceRestMarketingHandlerEventHandlerMarketingTrackingConsent
 */
export interface ComIbmCommerceRestMarketingHandlerEventHandlerMarketingTrackingConsent {
     ...
     * @type {number}
     * @memberof ComIbmCommerceRestMarketingHandlerEventHandlerMarketingTrackingConsent
     */
