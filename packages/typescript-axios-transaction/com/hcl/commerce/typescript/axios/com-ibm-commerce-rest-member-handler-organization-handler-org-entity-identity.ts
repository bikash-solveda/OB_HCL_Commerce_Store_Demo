 ...
 * @export
 * @interface ComIbmCommerceRestMemberHandlerOrganizationHandlerOrgEntityIdentity
 */
export interface ComIbmCommerceRestMemberHandlerOrganizationHandlerOrgEntityIdentity {
    /**
     * The organization entity identifier.
     * @type {string}
     * @memberof ComIbmCommerceRestMemberHandlerOrganizationHandlerOrgEntityIdentity
     */
    orgEntityId: string;
    /**
