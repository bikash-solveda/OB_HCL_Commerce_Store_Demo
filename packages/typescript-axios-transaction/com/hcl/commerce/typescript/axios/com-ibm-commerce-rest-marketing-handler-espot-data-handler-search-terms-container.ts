 ...
 * @export
 * @interface ComIbmCommerceRestMarketingHandlerESpotDataHandlerSearchTermsContainer
 */
export interface ComIbmCommerceRestMarketingHandlerESpotDataHandlerSearchTermsContainer {
     ...
     * @type {string}
     * @memberof ComIbmCommerceRestMarketingHandlerESpotDataHandlerSearchTermsContainer
     */
    searchTerms: string;
}
