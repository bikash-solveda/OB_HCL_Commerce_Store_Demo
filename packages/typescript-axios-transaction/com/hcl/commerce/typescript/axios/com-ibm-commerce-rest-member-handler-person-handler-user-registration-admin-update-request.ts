 ...
 * @export
 * @interface ComIbmCommerceRestMemberHandlerPersonHandlerUserRegistrationAdminUpdateRequest
 */
export interface ComIbmCommerceRestMemberHandlerPersonHandlerUserRegistrationAdminUpdateRequest {
     ...
     * @type {string}
     * @memberof ComIbmCommerceRestMemberHandlerPersonHandlerUserRegistrationAdminUpdateRequest
     */
    address1?: string;
    /**
     * The registrant\'s street address, to a maximum of three lines of information.
