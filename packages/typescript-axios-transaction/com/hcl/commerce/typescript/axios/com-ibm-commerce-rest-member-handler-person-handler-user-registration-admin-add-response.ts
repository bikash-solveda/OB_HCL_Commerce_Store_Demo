 ...
 * @export
 * @interface ComIbmCommerceRestMemberHandlerPersonHandlerUserRegistrationAdminAddResponse
 */
export interface ComIbmCommerceRestMemberHandlerPersonHandlerUserRegistrationAdminAddResponse {
    /**
     * The user unique identifier.
     * @type {string}
     * @memberof ComIbmCommerceRestMemberHandlerPersonHandlerUserRegistrationAdminAddResponse
     */
    userId: string;
    /**
