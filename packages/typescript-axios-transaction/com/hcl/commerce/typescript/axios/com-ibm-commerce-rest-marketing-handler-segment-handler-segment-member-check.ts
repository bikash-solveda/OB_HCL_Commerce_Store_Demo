 ...
 * @export
 * @interface ComIbmCommerceRestMarketingHandlerSegmentHandlerSegmentMemberCheck
 */
export interface ComIbmCommerceRestMarketingHandlerSegmentHandlerSegmentMemberCheck {
     ...
     * @type {boolean}
     * @memberof ComIbmCommerceRestMarketingHandlerSegmentHandlerSegmentMemberCheck
     */
