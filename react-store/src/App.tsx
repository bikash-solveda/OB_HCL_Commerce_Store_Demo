...
import { isInForUserSession, storageSessionHandler } from "./_foundation/utils/storageUtil";
...
const App: React.FC = (props: any) => {
  ...
  const fetchForUserDetailsCompleted = useSelector(fetchForUserDetailsCompletedSelector);
  const isForUserSession = isInForUserSession();
  const userInitiated = useSelector(userInitStatusSelector);
  ...
  React.useEffect(() => {
    if (mySite) {
      ...
      if (!isForUserSession || fetchForUserDetailsCompleted) {
  ...
  }, [mySite, dispatch, fetchForUserDetailsCompleted]);
  ...
  return mySite && isStoreOpen && (!isForUserSession || fetchForUserDetailsCompleted) ? (
