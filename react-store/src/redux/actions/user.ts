...
const INIT_STATE_FROM_STORAGE_ACTION = createAction<any, string>(ACTIONTYPES.INIT_STATE_FROM_STORAGE);

const FETCH_USER_DETAILS_SUCCESS_ACTION = createAction<any, string>(ACTIONTYPES.FETCH_USER_DETAILS_SUCCESS);
...
const INIT_USER_FROM_STORAGE_FETCH_CART_ACTION = createAction<any, string>(
  ACTIONTYPES.INIT_USER_FROM_STORAGE_FETCH_CART
);
export {
