...
import { FLOW_REMEMBER_ME_PARTIAL_AUTH } from "_foundation/constants/user";
//Custom libraries
...
function SignInLayout({ cid, hideRegistrationPage, ...props }: SignInContext) {
  ...
  const { flow } = (state as any) ?? {};
  const navigate = useNavigate();
  const signInTitle = checkoutFlow
    ? t("SignIn.SignInAndCheckoutTitle")
    : flow && flow === FLOW_REMEMBER_ME_PARTIAL_AUTH
          ...
          <>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <StyledBox textAlign="center">
                ...
                {!isB2B && !(flow && flow === FLOW_REMEMBER_ME_PARTIAL_AUTH) ? (
                  <>
