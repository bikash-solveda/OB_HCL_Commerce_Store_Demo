...
export const SessionErrorDialog = () => {
  ...
  }, [widgetName, rememberMe, dispatch, navigate, storeLocatorDispach]);

  useEffect(() => {
    if (userInitStatus && !loginStatus && handled === false && !rememberMe) {
      handleCancel();
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [loginStatus, userInitStatus, handled, rememberMe]);
  ...
  if (handled === undefined || handled === null || (!loginStatus && !rememberMe)) {
    return <></>;
  } else if (forUserId) {
