...
import { DescriptiveAttributes } from "components/widgets/detail-page-tabs";
...
const useProductDetails = (page: Page) => {
  ...
  if (displayDescriptiveAttrList.length > 0) {
    productDetailTabsChildren.push({
      ...
      tabContent: <DescriptiveAttributes partNumber={productPartNumber} attributes={displayDescriptiveAttrList} />,
    });
  }
