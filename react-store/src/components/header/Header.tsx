...
import logo from "../../sapphireimages/images/ON_Logo_notagline_horizontal_RGB.png";
...
const Header: React.FC<HeaderProps> = (props: any) => {
  ...
  useEffect(() => {
    if ((!userLoggedIn || userRemembered) && userPreviousLoggedIn.current) {
      setMyAccountPopperOpen(false);
      setMiniCartPopperOpen(false);
      navHome();
    }
    userPreviousLoggedIn.current = userLoggedIn && !userRemembered;
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [userLoggedIn, userRemembered]);
  ...
  return (
    <>
      <StyledHeader className="header header-wrapper">
        <StyledContainer>
          <StyledGrid container justifyContent="space-between" alignItems="center">
            <StyledGrid item>
              <StyledGrid className="header-mini-nav header-topbarSection" container alignItems="center" spacing={2}>
                <StyledGrid item>
                  <Hidden mdUp>
            ...
            <StyledGrid item>
              <StyledGrid
                className="header-mini-nav header-topbarSection"
                container
                alignItems="center"
                direction="row">
                <Hidden mdUp>
                ...
                {userLoggedIn && !userRemembered ? (
                  ...
                  <StyledGrid item style={{ display: "flex", alignItems: "center" }}>
                    <StyledLink to={userRemembered ? (isB2B ? ROUTES.DASHBOARD : ROUTES.ACCOUNT) : ROUTES.SIGNIN}>
